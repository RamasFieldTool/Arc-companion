// V2.14.0 TEST — isolated surface + accent controls.
(()=>{
  const root=document.documentElement;
  const surfaceKey='arcPaletteSurfaceTestUXV2140';
  const accentKey='arcPaletteAccentTestUXV2140';
  ...
  function syncText(){
    ...
    document.querySelectorAll('.palette-lab-action').forEach(element=>element.textContent=text.change);
    document.querySelectorAll('[data-palette-surface]').forEach(button=>{
