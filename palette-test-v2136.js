// V2.13.6 TEST — surface + accent controls, stored separately from the production theme.
(()=>{
  const root=document.documentElement;
  const surfaceKey='arcPaletteSurfaceTestV2136';
  const accentKey='arcPaletteAccentTestV2136';
